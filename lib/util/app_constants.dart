...
class AppConstants {
  static const String APP_NAME = 'SqabyFood';
  static const double APP_VERSION = 2.1;
  static const double APP_VERSION_SQABY = 2.1;

  static const String BASE_URL = "https://sqabyfood.sqaby.com";
  ...
  static const String WHATSAPP_LOGIN_URI = '/api/v1/auth/whatsapp-login';
  ...
  static const String ORDER_REVIEW_URI = '/api/v1/customer/order/review';
  static const String ORDER_DELIVERY_REVIEW_URI = '/api/v1/customer/order/review-delivery';
