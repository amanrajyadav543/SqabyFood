...
class OrderRepo {
  ...
  Future<Response> getItemReviewDetails(String orderId) async {
    return await apiClient.getData('${AppConstants.ORDER_REVIEW_URI}?order_id=$orderId');
  }

  Future<Response> getSubmitDeliveryReviews(String orderId) async {
    return await apiClient.getData('${AppConstants.ORDER_DELIVERY_REVIEW_URI}?order_id=$orderId');
  }
