...
class AuthRepo {
  ...
  Future<Response> whatsapplogin({String? phone}) async {
    return await apiClient.postData(AppConstants.WHATSAPP_LOGIN_URI, {"phone": phone});
  }
  ...
  Future<Response> verifyPhone(String phone, String otp, bool whatsapp) async {
    return await apiClient
        .postData(AppConstants.VERIFY_PHONE_URI, {"phone": phone, "otp": otp, "whatsapp" : whatsapp});
  }
  ...
  Future<bool> saveUserToken(String token) async {
    ...
    apiClient.updateHeader(
        token, null, sharedPreferences.getString(AppConstants.LANGUAGE_CODE),null,null);
