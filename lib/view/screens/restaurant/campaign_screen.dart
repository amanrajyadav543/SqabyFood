                      ...
                      child: ClipRRect(
                        ...
                        child: CustomImage(
                          ...
                          image:
                              ...
                              campaignImageUrl}/${widget.campaign.image}',
                        ),
                      ),
                    ),
                  )
                          ...
                          Row(children: [
                            ClipRRect(
                              ...
                              child: CustomImage(
                                image:
                                    '${Get.find<SplashController>().configModel?.baseUrls?.
                                    campaignImageUrl}/${campaignController.campaign?.image}',
                                height: 40,
                                width: 50,
                                fit: BoxFit.cover,
                              ),
                              ...
                              ? Row(children: [
                                  ...
                                  Text(
                                    '${DateConverter.stringToLocalDateOnly(
                                      campaignController.campaign!.availableDateStarts!)}'
                                    ' - ${DateConverter.stringToLocalDateOnly(campaignController.
