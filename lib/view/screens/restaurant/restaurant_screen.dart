...
import 'package:sqabyfood_sqaby/data/model/response/category_model.dart';
...
import 'package:sqabyfood_sqaby/view/screens/restaurant/widget/restaurant_description_view.dart';
                                              ...
                                              child: ClipRRect(
                                                ...
                                                child: CustomImage(
                                                  ...
                                                  image:
                                                      ...
                                                      ?.restaurantCoverPhotoUrl}/${_restaurant?.coverPhoto}',
                                                ),
                                              ),
                                            ),
                                            SizedBox(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          _restaurant?.discount?.discountType ==
                                              ...
                                              : '${'enjoy'.tr} ${PriceConverter.convertPrice(
                                        ...
                                        _restaurant?.discount?.maxDiscount != 0
                                            ...
                                            : SizedBox(),
                                        Text(
                                          '[ ${'daily_time'.tr}: ${DateConverter.convertTimeToTime(
                                            _restaurant!.discount!.startTime!)} '
