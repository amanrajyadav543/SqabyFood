...
class ProductReviewWidget extends StatefulWidget {
  ...
  ProductReviewWidget({required this.orderDetailsList,this.submitreviewlist});
                  ...
                  itemBuilder: (context, index) {
                    return Container(
                      ...
                      child: Column(children: [
                        ...
                        SizedBox(
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, i) {
                              ...
                              return InkWell(
                                child: widget.submitreviewlist![index].submitted! ?
                                Icon(
                                  widget.submitreviewlist![index].rating! < (i + 1) ? Icons.star_border : Icons.star,
                                  size: 25,
                                  color: widget.submitreviewlist![index].rating! < (i + 1) ? Theme.of(context).disabledColor
                                ...
                                onTap: widget.submitreviewlist![index].submitted! ? null : () {
                        ...
                        SizedBox(height: Dimensions.PADDING_SIZE_LARGE),
                        !widget.submitreviewlist![index].submitted! ?
                        MyTextField(
                          maxLines: 3,
                          ...
                          capitalization: TextCapitalization.sentences,
                          isEnabled: false,
                          hintText: widget.submitreviewlist![index].comment!,
                          fillColor: Theme.of(context).disabledColor.withOpacity(0.05),
                          onChanged: (text) => productController.setReview(index, text),
                        ) ,
                        SizedBox(height: 20),
