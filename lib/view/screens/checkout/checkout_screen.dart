...
import 'package:sqabyfood_sqaby/data/model/body/place_order_body.dart';
import 'package:sqabyfood_sqaby/data/model/response/address_model.dart';
import 'package:sqabyfood_sqaby/data/model/response/cart_model.dart';
import 'package:sqabyfood_sqaby/data/model/response/product_model.dart';
import 'package:sqabyfood_sqaby/helper/date_converter.dart';
...
import 'package:sqabyfood_sqaby/view/base/not_logged_in_screen.dart';
import 'package:sqabyfood_sqaby/view/screens/address/widget/address_widget.dart';
import 'package:sqabyfood_sqaby/view/screens/cart/widget/delivery_option_button.dart';
import 'package:sqabyfood_sqaby/view/screens/checkout/widget/address_dialogue.dart';
import 'package:sqabyfood_sqaby/view/screens/checkout/widget/payment_button.dart';
import 'package:sqabyfood_sqaby/view/screens/checkout/widget/tips_widget.dart';
import 'package:flutter/services.dart';
import 'package:get/get.dart';
import 'package:google_maps_flutter/google_maps_flutter.dart';
import 'package:universal_html/html.dart' as html;
import 'package:flutter/material.dart';
import 'package:sqabyfood_sqaby/view/screens/checkout/widget/wallet_check_box.dart';
              ...
              return GetBuilder<RestaurantController>(
                ...
                if (restController.restaurant != null) {
                  for (ZoneData zData in Get.find<LocationController>()
                      .getUserAddress()!
                      .zoneData!) {
                    if (zData.id == restController.restaurant!.zoneId) {
                  ...
                  if (locationController.addressList != null) {
                    for (int index = 0;
                      ...
                      if (locationController.addressList![index].zoneIds!
                        ...
                        _addressList
                            .add(locationController.addressList![index]);
                      }
                    }
                  }
                          ...
                          restController.restaurant?.selfDeliverySystem == 1
                              ...
                              : (_zoneCharge != null
                                  ...
                                  : Get.find<SplashController>()
                                      ...
                                      .minimumShippingCharge);
                      _deliveryCharge =
                          orderController.distance! * _perKmCharge!;
                                ...
                                child: Center(
                                  ...
                                  borderRadius: BorderRadius.circular(Dimensions.RADIUS_SMALL),
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              items: orderController.slotIndexList?.
                                                                              map((int value) {
                                                                                      ...
                                                                                      : '${
                                                                                        ...
                                                                                        .dateToTimeOnly(
                                                                                          ...
                                                                                          '- ${DateConverter.dateToTimeOnly(
                                                                                            orderController.timeSlots![value].endTime!)}'),
                                                                                );
                                                                              }).toList(),
                                                                              onChanged: (int? value) {
                                                    ...
                                                    children: [
                                                        ...
                                                        Text(
                                                            '(-) ${PriceConverter.convertPrice(
                                                              ...
                                                              ?.walletBalance != null ? Get.find<UserController
                                                              >().userInfoModel!.walletBalance! > 
                                                              _total ? _total : Get.find<UserController>()
                                                              .userInfoModel!.walletBalance! : 0.0)}',
                                                            style:
                                                                robotoRegular),
                                                      ])
                                                : SizedBox(),
...
//                                                         )
  ...
  void _callback(bool isSuccess, String message, String orderID, double amount,
      double wallet) async {
    log("---------------------------------------------------------------------------${amount.toString()}--------------------");
    if (isSuccess) {
      ...
      if (Get.find<OrderController>().paymentMethodIndex == 0 ||
        ...
        if (wallet == 0) {
          ...
          String selectedUrl =
              '${AppConstants.BASE_URL}/payment-mobile?order_id=$orderID&customer_id=${
                Get.find<UserController>().userInfoModel?.
                id}&&callback=$protocol//$hostname${RouteHelper
                .orderSuccess}?id=$orderID&amount=$amount&status=';
