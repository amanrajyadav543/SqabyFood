...
import 'package:sqabyfood_sqaby/view/screens/search/widget/item_view.dart';
...
class _SearchResultWidgetState extends State<SearchResultWidget>
  ...
  Widget build(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      GetBuilder<SearchControllerr>(builder: (searchController) {
        bool _isNull = true;
        int _length = 0;
      ...
      Expanded(
        ...
        onNotification: (scrollNotification) {
          if (scrollNotification is ScrollEndNotification) {
            Get.find<SearchControllerr>()
                .setRestaurant(_tabController?.index == 1);
            Get.find<SearchControllerr>().searchData(widget.searchText);
          }
          return false;
        },
        child: TabBarView(
