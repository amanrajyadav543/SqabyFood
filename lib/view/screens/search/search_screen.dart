...
import 'package:sqabyfood_sqaby/view/base/bottom_cart_widget.dart';
...
import 'package:sqabyfood_sqaby/view/screens/search/widget/filter_widget.dart';
import 'package:sqabyfood_sqaby/view/screens/search/widget/search_field.dart';
import 'package:sqabyfood_sqaby/view/screens/search/widget/search_result_widget.dart';
...
class _SearchScreenState extends State<SearchScreen> {
  ...
  void initState() {
    ...
    if (_isLoggedIn!) {
      Get.find<SearchControllerr>().getSuggestedFoods();
    }
    Get.find<SearchControllerr>().getHistoryList();
  }
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async {
        if (Get.find<SearchControllerr>().isSearchMode) {
          return true;
        } else {
          Get.find<SearchControllerr>().setSearchMode(true);
          return false;
        }
      },
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          child: GetBuilder<SearchControllerr>(builder: (searchController) {
                                                              ...
                                                              child:
                                                                ...
                                                                image:
                                                                    '${
                                                                      ...
                                                                      configModel!.baseUrls!.productImageUrl}'
  ...
  void _actionSearch(SearchControllerr searchController, bool isSubmit) {
