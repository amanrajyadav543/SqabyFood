                                                      ...
                                                      children: [
                                                        Text(
                                                          '${couponController.couponList![
                                                            index].code} (${couponController.couponList![index].title})',
                                                          style: robotoRegular
                                                              .copyWith(
                                                                  color: Theme.of(
                                                                          context)
                                                        ...
                                                        Text(
                                                          '${couponController.couponList![index].discount}${
                                                            couponController.couponList![index].discountType
                                                             == 'percent' ? '%' : Get.find<SplashController>()
                                                             .configModel!.currencySymbol} off',
                                                          style: robotoMedium
                                                              .copyWith(
                                                                  color: Theme.of(
                                                                          context)
                                                        ...
                                                        Row(children: [
                                                          ...
                                                          Flexible(
                                                            ...
                                                            couponController
                                                                   ...
                                                                   ! .tr +
                                                                '${couponController.couponList![
                                                                  index].couponType == 'restaurant_wise' ? ' (${
                                                                    couponController.couponList![
                                                                      index].data})' : ''}',
                                                            style: robotoMedium.copyWith(
                                                                color: Theme.of(
