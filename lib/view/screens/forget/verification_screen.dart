...
import 'package:sqabyfood_sqaby/view/base/custom_dialog.dart';
            ...
            return Column(children: [
              ...
              authController.verificationCode.length == 4
                ...
                onPressed: () {
                  if(widget.fromSignUp) {
                       log('-------------------');
                    authController.verifyPhone(_number!,widget.whatsapp).then(( value) {
                      if( value.isSuccess!) {
                        log('-------------------');
                        if(value.signup!){
                          ...
                          showAnimatedDialog(context, Center(
                            child: Container(
                              ...
                              child: Column(mainAxisSize: MainAxisSize.min, children: [
                                ...
                                Text('login'.tr, style: robotoBold.copyWith(
                        ...
                        //    Get.tofNamed(RouteHelper.getAccessLocationRoute('verification'));
                          });
                        }
