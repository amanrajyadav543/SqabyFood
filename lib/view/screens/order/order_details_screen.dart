...
import 'package:sqabyfood_sqaby/view/base/confirmation_dialog.dart';
...
import 'package:sqabyfood_sqaby/view/screens/order/widget/order_product_widget.dart';
import 'package:sqabyfood_sqaby/view/screens/review/rate_review_screen.dart';
...
class _OrderDetailsScreenState extends State<OrderDetailsScreen> {
  ...
  void _loadData(BuildContext context, bool reload) async {
    ...
    Get.find<OrderController>().getSubmitReviews(widget.orderId.toString());
    Get.find<OrderController>().getDeliverySubmitReviews(widget.orderId.toString());
  }
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async {
        if (widget.orderModel == null) {
          return Get.offAllNamed(RouteHelper.getInitialRoute()) as  bool;
        } else {
          return true;
        }
      },
                                                    ...
                                                    children: [
                                                      Text(
                                                        DateConverter.differenceInMinute(
                                                            ...
                                                            ? '1 - 5'
                                                            : '${DateConverter.differenceInMinute(
                                                              _order.restaurant?.deliveryTime, _order.createdAt!, _order.processingTime, _order.scheduleAt) - 5} '
                                                                '- ${DateConverter
                                                                .differenceInMinute(_order.restaurant?.
                                                                deliveryTime, _order.createdAt!, _order.processingTime, _order.scheduleAt)}',
                                      ...
                                      ? Row(children: [
                                          ClipOval(
                                            ...
                                            image:
                                                ...
                                                restaurantImageUrl}/${_order.restaurant?.logo}',
                                            height: 35,
                                            width: 35,
                                            fit: BoxFit.cover,
                                          )),
                          ...
                          child: Container(
                            ...
                            child: CustomButton(
                              ...
                              onPressed: () {
                                ...
                                List<SubmitReviewModel> _submitreviewList = [];
                                ...
                                orderController.submitReview!.forEach((submitReview) {
                                  _submitreviewList.add(submitReview);
                                });
                                Get.toNamed(RouteHelper.getReviewRoute(),
                                    arguments: RateReviewScreen(
                                      ...
                                      orderID: _order.id!,
                                      submitreviewlist: _submitreviewList,
                                      submitDeliveryReviewModel: orderController.submitdelivery,
                                    ));
                              },
                            ),
                          ),
