...
import 'package:sqabyfood_sqaby/view/screens/order/widget/order_shimmer.dart';
                                        ...
                                        ClipRRect(
                                          ...
                                          child: CustomImage(
                                            image:
                                                ...
                                                '/${orderList![
                                                  index].restaurant != null ? orderList[index].restaurant!.
                                                  logo : ''}',
                                            height: 60,
                                            width: 60,
                                            fit: BoxFit.cover,
                                        ...
                                        Column(
                                            ...
                                            children: [
                                              ...
                                              isRunning
                                                  ...
                                                  : Text(
                                                      '${orderList[index]
                                                      .detailsCount} ${orderList[index].detailsCount!
                                                       > 1 ? 'items'.tr : 'item'.tr}',
                                                      style: robotoRegular.copyWith(
                                                          fontSize: Dimensions
                                                              .fontSizeExtraSmall),
