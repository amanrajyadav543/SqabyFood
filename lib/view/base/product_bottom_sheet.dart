...
import 'package:sqabyfood_sqaby/view/base/discount_tag_without_image.dart';
import 'package:sqabyfood_sqaby/view/base/quantity_button.dart';
                                  ...
                                  GridView.builder(
                                    ...
                                    itemBuilder: (context, i) {
                                      return InkWell(
                                        onTap: () {
                                          print(
                                              '---check for update  ${widget.cart != null ? widget.cart!.
                                              toJson() : null} and ${productController.cartIndex}-----');
                                          print(
                        ...
                        _isAvailable
                            ...
                            : Container(
                                ...
                                child: Column(children: [
                                  ...
                                  Text(
                                    '${'available_will_be'.tr} ${DateConverter.convertTimeToTime(widget.product
                                    .availableTimeStarts!)} '
